            ...
            <div className="grid md:grid-cols-2 gap-3 mb-6">
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600 break-words whitespace-normal" style={{ overflowWrap: 'anywhere' }}>
              ...
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">{t('billing.benefit2Desc', 'Ce analize ar trebui să faci, bazat pe profilul tău')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">{t('billing.benefit3Desc', 'Descarcă rapoartele pentru a le arăta medicului')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">{t('billing.benefit4Desc', 'Compară analizele de acum cu cele din trecut')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-slate-600">{t('billing.benefit5Desc', 'Conectează Regina Maria, Synevo, Medlife, etc.')}</p>
                </div>
              </div>
              <div className="flex items-start gap-3 bg-white/70 rounded-lg p-3">
          ...
          <div className="bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 rounded-2xl border border-purple-200 p-6">
            ...
            <div className="grid md:grid-cols-3 gap-3 mb-4">
              <div className="bg-white/70 rounded-lg p-3 text-center">
                ...
                <p className="text-xs sm:text-sm text-slate-600">{t('billing.familyMembers', 'Soț/soție, copii, părinți')}</p>
              </div>
              <div className="bg-white/70 rounded-lg p-3 text-center">
                ...
                <p className="text-xs sm:text-sm text-slate-600">{t('billing.privateAccounts', 'Fiecare cu contul său privat')}</p>
              </div>
              <div className="bg-white/70 rounded-lg p-3 text-center">
                ...
                <p className="text-xs sm:text-sm text-slate-600">{t('billing.forEachMember', 'Pentru fiecare membru')}</p>
              </div>
            </div>
        ...
        <div className="p-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-slate-800">
              {t('billing.billingHistory', 'Billing History')}
            </h3>
          </div>
        </div>
