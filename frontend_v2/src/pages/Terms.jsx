        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-amber-700 text-sm">
              {isRomanian
                ? 'Analize.Online NU oferă sfaturi medicale. Serviciul nostru este exclusiv informativ și nu înlocuiește consultul medical profesionist. Întotdeauna consultați un medic pentru decizii privind sănătatea dumneavoastră.'
                : 'Analize.Online does NOT provide medical advice. Our service is for informational purposes only and does not replace professional medical consultation. Always consult a doctor for decisions about your health.'}
            </p>
          </div>
        </div>
      </div>
        ...
        {isRomanian ? (
          <>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                Prin accesarea sau utilizarea serviciului Analize.Online („Serviciul"), sunteți de acord să fiți obligat de acești Termeni și Condiții („Termenii"). Dacă nu sunteți de acord cu oricare parte a acestor Termeni, nu aveți dreptul să accesați Serviciul.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                Analize.Online este o platformă de agregare a datelor medicale care permite utilizatorilor să:
              </p>
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  <strong>3.1.</strong> Serviciul Analize.Online NU oferă sfaturi medicale, diagnostic sau recomandări de tratament. Toate interpretările și analizele generate de inteligența artificială sunt exclusiv în scop informativ.
                </p>
                <p>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                Serviciul și conținutul său original, caracteristicile și funcționalitățile sunt și vor rămâne proprietatea exclusivă a Analize.Online. Serviciul este protejat de legile privind drepturile de autor, mărcile comerciale și alte legi.
              </p>
            </section>
          ...
          <>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                By accessing or using the Analize.Online service ("Service"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree with any part of these Terms, you may not access the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed mb-4">
                Analize.Online is a medical data aggregation platform that allows users to:
              </p>
              <ul className="list-disc list-inside text-slate-600 space-y-2 ml-4">
            ...
            <section>
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                <p>
                  <strong>3.1.</strong> The Analize.Online Service does NOT provide medical advice, diagnosis, or treatment recommendations. All AI-generated interpretations and analyses are for informational purposes only.
                </p>
                <p>
            ...
            <section>
              ...
              <p className="text-slate-600 leading-relaxed">
                The Service and its original content, features, and functionality are and will remain the exclusive property of Analize.Online. The Service is protected by copyright, trademark, and other laws.
              </p>
            </section>
